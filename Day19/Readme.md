...
person_json = "{'name': 'Paarthav', 'country': 'India, 'city': 'Faridabad', 'skills': ['JavaScrip', 'React', 'Python']}"
...
# output
<class 'dict'>
{'name': 'Paarthav', 'country': 'India', 'city': 'Faridabad', 'skills': ['JavaScrip', 'React', 'Python']}
Paarthav
```
...
"Paarthav","India","Faridabad","JavaScrip"
```
...
with open('./files/csv_example.csv') as f:
    ...
    for row in csv_reader:
        if line_count == 0:
            ...
            print(
                f'\t{row[0]} is a student. He lives in {row[1]}, {row[2]}.')
            line_count += 1
...
Column names are :name, country, city, skills
        Paarthav is a student. He lives in India, Faridabad.
Number of lines:  2
```
